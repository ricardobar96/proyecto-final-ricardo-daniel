...
public class PistaAdapter extends ArrayAdapter<Pista> {
    ...
    public View getView(final int pos, View convertView, ViewGroup parent){
        ...
        TextView txtInfopista = (TextView) rowView.findViewById(R.id.pistaInfoTextView);
        ...
        txtInfopista.setText(String.format("%s", pistas.get(pos).getContenido()));
        ...
        rowView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("usuario", pistas.get(pos).getUsuario());
