...
export default function Settings() {
    ...
    function changeAvatar() {
        ...
        const newUsuario = new usuarios(usuarioActual.id, usuarioActual.nombre, usuarioActual.password, usuarioActual.rol,
            ...
            usuarioActual.followeds, usuarioActual.followers, stUser.usuario!.juegoUsuarios, stUser.usuario!.reviews,
            stUser.usuario!.pistas, stUser.usuario!.mensajesEnviados, stUser.usuario!.mensajesRecibidos);
